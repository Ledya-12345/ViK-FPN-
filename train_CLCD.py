...
class CDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Resize images and mask to 256x256 to match Table 3's Input Size
...
def main():
    ...
    parser.add_argument("--train_root", type=str, default="dataset/CLCD/train")
    parser.add_argument("--val_root", type=str, default="dataset/CLCD/val")
    parser.add_argument("--epochs", type=int, default=100)  
    parser.add_argument("--batch_size", type=int, default=8)  
    parser.add_argument("--seed", type=int, default=42)       
    parser.add_argument("--config", type=str, default=None,
                         help="Optional path to a YAML config (e.g. configs/clcd.yaml) "
    ...
    logger = CSVLogger("lightning_logs", name="CLCD")
